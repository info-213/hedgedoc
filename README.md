...
CMD_DB_URL: посилання для підключення до PostgreSQL.
...
Для зупинки сервісів та повного видалення контейнерів разом із даними виконайте:

```bash
docker compose down --volumesЗупинка та очищення
